...
module.exports.onLoad = async function() {
  ...
  const url =
    "https://raw.githubusercontent.com/ProCoderMew/Module-Miraiv2/main/data/alime.json";
...
module.exports.run = async function({ event, api, args }) {
  const { writeFileSync, createReadStream, unlinkSync } = global.nodemodule[
    "fs-extra"
  ];
  const { resolve } = global.nodemodule["path"];
  ...
  const out = (msg, callback = function() {}) =>
